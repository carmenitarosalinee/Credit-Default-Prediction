...
st.markdown("Visualisasi dan prediksi menggunakan machine learning terhadap data transaksi kredit.")
...
if uploaded_file:
    ...
    st.subheader("2. Distribusi Kelas")
    fig, ax = plt.subplots()
    ...
    st.info("Silakan upload file `creditcard.csv` untuk memulai.")
